...
{
    [CreateAssetMenu(fileName = "ConfigCurrencyIcons", menuName = "Configs/Meta/Wallet/ConfigCurrencyIcons", order = 0)]
    public class ConfigCurrencyIcons : ScriptableObject
    {
        [SerializeField] private List<CurrencyConfig> _configs;
        
        public Sprite GetSpriteFor(CurrencyType type)
